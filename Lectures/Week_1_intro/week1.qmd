...
```{r, echo=TRUE, include=TRUE}
# read csv file
mydata <- read.csv("C:/Users/hmehm/OneDrive - marmara.edu.tr/mac_projects 2/R_lecture/data/cars.csv") 
View(mydata)
# write csv
write.csv(mydata, file = "~/Library/CloudStorage/OneDrive-marmara.edu.tr/mac_projects 2/R_lecture/data/mydata.csv")

# read csv-file from net
mydata <- read.csv("https://gist.githubusercontent.com/MorganZhang100/0c489d1f376a04d5436a/raw/7c335ebe48e5751f1334bb6e4502254e3c1d1c55/cars.csv")
View(mydata)

# read excel
library(readxl)
mydata1 <- read_excel("C:/Users/hmehm/OneDrive - marmara.edu.tr/mac_projects 2/R_lecture/data/datacom.xlsx")
View(mydata1)
...
```{r}
dpath <- "C:/Users/hmehm/OneDrive - marmara.edu.tr/mac_projects 2/R_lecture/data"
